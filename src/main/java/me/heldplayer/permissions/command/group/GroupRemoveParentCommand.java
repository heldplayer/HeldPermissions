...
public class GroupRemoveParentCommand extends AbstractSubCommand {
    ...
    public void runCommand(CommandSender sender) {
        ...
        Permissions.notify(ChatUtil.constructMessage(ChatColor.GREEN, "Removed parent '", ChatColor.WHITE,
                parent.name, ChatColor.RESET, "' of '", ChatColor.WHITE,
                child.name, ChatColor.RESET, "'"), sender, Consts.PERM_LISTEN_CONFIG);
