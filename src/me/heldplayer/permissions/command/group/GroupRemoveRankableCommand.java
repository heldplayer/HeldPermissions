...
public class GroupRemoveRankableCommand extends AbstractSubCommand {
    ...
    public void runCommand(CommandSender sender, String alias, String... args) {
        ...
        if (!permissions.doesInheritFrom(rankableGroup)) {
            sender.sendMessage(Permissions.format("Group '%s' can't rank '%s'", ChatColor.RED, group, rankable));
            return;
        }

        permissions.removeRankable(rankableGroup);
        sender.sendMessage(Permissions.format("Made '%s' unable to rank '%s'", ChatColor.GREEN, group, rankable));
    ...
    public List<String> getTabCompleteResults(CommandSender sender, String alias, String... args) {
        ...
        if (args.length == 2) {
            ...
            return new ArrayList<String>(permissions.getRankables());
        }
