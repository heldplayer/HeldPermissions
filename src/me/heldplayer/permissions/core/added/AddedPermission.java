...
public class AddedPermission implements Comparable<AddedPermission> {
    ...
    @Override
    public int compareTo(AddedPermission other) {
    ...
    public void load(ConfigurationSection section) {
        ...
        this.children = new TreeSet<String>(section.getStringList("children"));
    }

    public void save(ConfigurationSection section) {
        section.set("description", this.description);
        section.set("default", this.defaultValue.name());
        section.set("children", new ArrayList<String>(this.children));
    }
